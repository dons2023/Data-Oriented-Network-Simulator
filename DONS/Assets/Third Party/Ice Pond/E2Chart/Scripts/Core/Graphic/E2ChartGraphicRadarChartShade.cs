...
{
    public class E2ChartGraphicRadarChartShade : E2ChartGraphic
    {
        ...
        protected override void GenerateMesh()
        {
            ...
            Vector2 pStart = direction[0] * Mathf.Lerp(radiusInner, radius, dataStart[0]);
            ...
            for (int i = 1; i < dataValue.Length + 1; ++i)
            {
                ...
                Vector2 lastPoint = p;
                pStart = direction[i] * Mathf.Lerp(radiusInner, radius, dataStart[index]);
